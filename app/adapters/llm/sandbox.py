...
_TYPE_KEYWORDS: list[tuple[str, str]] = [
    ...
    ("login", "account"),
    ("account", "account"),
    ("outage", "technical_support"),
    ("production down", "technical_support"),
    ("production is down", "technical_support"),
    ("service down", "technical_support"),
    ("site down", "technical_support"),
    ("systems down", "technical_support"),
    ("server down", "technical_support"),
    ("is down", "technical_support"),
    ("not responding", "technical_support"),
    ("downtime", "technical_support"),
